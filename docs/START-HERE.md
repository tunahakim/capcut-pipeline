...
Đừng đưa cả loạt lệnh khi bước sau phụ thuộc output bước trước, nhưng bước độc lập thì gộp vào một khối, vì mỗi lượt đối đáp gửi lại toàn bộ hội thoại nên chia nhỏ việc độc lập là tự đốt ngân sách. Mỗi lượt nói rõ **đang ở đâu trong lộ trình**. Mỗi phiên nhắc người dùng kiểm tra đã `git pull --rebase` và đã push chưa.
